...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        if len(checked_cells) > 0:
            self.knowledge.append(Sentence(checked_cells, count))
        # requirement 4
        ...
        for sentence1 in self.knowledge:
            if len(sentence1.cells) == sentence1.count:
                for sentence2 in self.knowledge:
                    if len(sentence2.cells) == sentence2.count and sentence1 != sentence2:
    ...
    def make_random_move(self):
        ...
        for move in (all_moves - self.moves_made) - self.mines:
            return move
        return None
